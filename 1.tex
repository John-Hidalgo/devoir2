...
b) $\{ n \in N \mid (\exists a \in \attribut\ \mid \langle \textsf{gnome},a  \rangle \in \textit{espèce} \land \langle a,n \rangle \in \textit{plus} \land n > \text{len}(\textsf{gnome}) )\}$
...
g) $\textit{espèce}^{c}$ contiennent des paires possibles qui n'existent pas donc sont les cartes \textit{espèce} qui n'ont jamais 
